...
class NovelProject(UUIDMixin, TimestampMixin, Base):
    ...
    pov_type: Mapped[str] = mapped_column(String(80), default="third_person_limited")
    tone: Mapped[str] = mapped_column(String(120), default="")
    writing_style_preset: Mapped[str] = mapped_column(String(40), default="general_web")
    writing_style_custom: Mapped[str] = mapped_column(Text, default="")
    default_scene_word_count: Mapped[int] = mapped_column(Integer, default=1000)
